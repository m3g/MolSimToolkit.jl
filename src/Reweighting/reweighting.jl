...
@testitem "Reweighting one frame" begin
    ...
    sum_of_dist = reweight(simulation, (i,j,d2) -> intermol_perturb(i, j, d2, dist), [i1[239]], i2, 25.0)
...
@testitem "Reweighting small trajectory" begin
    ...
    sum_of_dist = reweight(simulation, (i,j,d2) -> intermol_perturb(i, j, d2, dist), i1, i2, 25.0)
